...
const directoryNames=['Aurora','Aurora Gaming','PARIVISION','BetBoom','BetBoom Team','SAW','Monte','9z','9z Team','Legacy','FUT','FUT Esports'];
...
module.exports={scoreSql,orderSql,featuredTeamNames,teamScore};
