  ...
  async function sync({force=false}={}){
    ...
    running=(async()=>{
      ...
      try{
        ...
        try{
          const names=[...new Set(ranked.teams.filter(t=>!rankingTools.academy(t.name)).flatMap(rankingTools.aliases).flatMap(n=>[n,n.toLowerCase(),n.toUpperCase(),n.replace(/\s+/g,'')]))];
