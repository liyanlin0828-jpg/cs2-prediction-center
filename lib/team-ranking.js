...
const extraAliases={innercircle:['Inner Circle Esports'],sinners:['Sinners Esports','SINNERS Esports'],sashi:['Sashi Esport'],baks:['BakS eSports'],bountyhunters:['Bounty Hunters Esports'],ww:['WW Team'],lag:['LAG Gaming'],unity:['UNiTY esports'],nemesis:['Team Nemesis'],betclic:['Betclic Apogee Esports','Betclic Apogee'],bcgame:['BC.Game Esports']};
