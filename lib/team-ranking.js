...
const extraAliases={dendele:['DENDELE CS'],betm:['BET-M 33'],eac:['Esport Academy Copenhagen','Esports Academy Copenhagen'],cybershoke:['CYBERSHOKE Esports'],lp:['largadosypelados','LargadosyPelados'],fluxo:['Fluxo W7M'],innercircle:['Inner Circle Esports'],sinners:['Sinners Esports','SINNERS Esports'],sashi:['Sashi Esport'],baks:['BakS eSports'],bountyhunters:['Bounty Hunters Esports'],ww:['WW Team'],lag:['LAG Gaming'],unity:['UNiTY esports'],nemesis:['Team Nemesis'],betclic:['Betclic Apogee Esports','Betclic Apogee'],bcgame:['BC.Game Esports']};
function queryNames(team){return aliases(team).flatMap(n=>[n,n.toLowerCase(),n.toUpperCase(),n.toLowerCase().replace(/\b[a-z]/g,c=>c.toUpperCase()),n.replace(/\s+/g,'')])}
...
module.exports={createRankingService,validate,parseRanking,indexTeams,aliases,queryNames,academy};
