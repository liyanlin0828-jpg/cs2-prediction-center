...
(async()=>{
  ...
  try{
    ...
    await runSql(client,'migration_v14.sql');
    await runSql(client,'migration_v15.sql');
    await runSql(client,'migration_v16.sql');
    await runSql(client,'migration_v17.sql');
    await runSql(client,'migration_v18.sql');
    await runSql(client,'migration_v19.sql');
    await runSql(client,'migration_v20.sql');
    await runSql(client,'migration_v21.sql');
